...
import { FINANCIAL_TERMS,PRIVACY_POLICY, TERMS_OF_SERVICE } from './terms';
...
function Footer() {
  ...
  return (
    <footer className="mo:p-[20px] flex flex-col bg-gray-600 px-[48px] py-[80px]">
      <span className="mo:text-[10px] ta:text-[16px] mb-[10px] block text-[16px] font-bold text-white">
        Copyright ⓒ Wikied. All Rights Reserved <br />
      </span>
      <div className="mb-[30px] flex flex-col gap-px">
        <span className="mo:text-[8px] text-[14px] font-normal text-white">
      ...
      <div className="mo:gap-[15px] flex gap-[30px]">
        <span
          className="mo:text-[8px] ta:text-[14px] cursor-pointer text-[14px] font-medium text-white hover:opacity-80"
